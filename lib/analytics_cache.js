...
var CLASSIFIERS_COLUMNS = ['id', 'classifier', 'last_updated'].concat(CLASSIFIERS);
...
AnalyticsRow.prototype.classifier_values = function() {
    return [this.classifier_id, this.joined_classifier, new Date(this.timestamp * 1000).toISOString()].concat(this.classifiers);
};
...
AnalyticsCache.prototype.record = function(key, value, timestamp) {
    ...
    this._pending.push(new AnalyticsRow(key, value, timestamp));
};
