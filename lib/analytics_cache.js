...
var AnalyticsCache = function(database_name, connection_pool) {
...
AnalyticsCache.prototype.flush = _.throttle(function() {
    ...
    while (this._pending.length > 0) {
        ...
        this._pool.acquire(function(err, connection) {
            connection.query(statement_template + statement_values.join(','), values, function(err, rows) {
                if (err) { this._pool.destroy(connection); }
